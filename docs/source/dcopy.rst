...
|    Y := X 
|
| Where X and Y are vectors of size n.
...
---------------------
	...
	**hcblasStatus** **hcblas_dcopy** (const int N, double* X, const int incX, const long XOffset, double* Y, const int incY, const long YOffset)
...
----------------------
	...
	**hcblasStatus** **hcblas_dcopy** (Concurrency::accelerator_view &accl_view, const int N, Concurrency::array<double> &X, const int incX, const long XOffset, Concurrency::array<double> &Y, const int incY, const long YOffset) 
...
-----------------------
	...
	**hcblasStatus** **hcblas_dcopy** (Concurrency::accelerator_view &accl_view, const int N, Concurrency::array<double> &X, const int incX, const long XOffset, Concurrency::array<double> &Y, const int incY, const long YOffset, const long X_batchOffset, const long Y_batchOffset, const int BatchSize) 
