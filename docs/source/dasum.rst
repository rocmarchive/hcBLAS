...
Absolute sum of values of a vector containing double elements (Double Precision).
...
----------------------
	...
	**hcblasStatus** **hcblas_dasum** (Concurrency::accelerator_view &accl_view, const int N, Concurrency::array<double> &X, const int incX, const long XOffset, double &Y)
...
-----------------------
	...
	**hcblasStatus** **hcblas_dasum** (Concurrency::accelerator_view &accl_view, const int N, Concurrency::array<double> &X, const int incX, const long XOffset, double &Y, const long X_batchOffset, const int BatchSize) 
