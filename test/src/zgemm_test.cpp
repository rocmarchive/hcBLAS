...
/* Implementation type II - Inputs and Outputs are HCC double array containers with batch processing */
        ...
        accl_view.copy(Abatch, devAbatch, M * K * sizeof(double_2));
        accl_view.copy(Bbatch, devBbatch, K * N * sizeof(double_2));
        ...
        for(int i = 0; i < batchSize;i++)
	     cblas_zgemm( order, Transa, Transb, M, N, K, &alpha, abatch, lda, bbatch, ldb, &beta, cbatch + i * M * N * 2, ldc );
