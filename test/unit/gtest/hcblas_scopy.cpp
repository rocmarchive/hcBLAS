...
/* Implementation type I - Inputs and Outputs are host float pointers */
    for(int i = 0; i < lenx; i++){
     ...
     /* X1 is NULL */
    status = hc.hcblas_scopy(N, X1, incX, xOffset, Y, incY, yOffset);
    EXPECT_EQ(status, HCBLAS_INVALID);
     /* Y1 is NULL */
    status = hc.hcblas_scopy(N, X, incX, xOffset, Y1, incY, yOffset);
    EXPECT_EQ(status, HCBLAS_INVALID);
    /* Proper call */
...
TEST(hcblas_scopy, func_correct_scopy_Implementation_type_3) {
    Hcblaslibrary hc;
    int N = 19;
    int incX = 1;
    int incY = 1;
...
TEST(hcblas_scopy, func_correct_scopy_Implementation_type_4) {
    Hcblaslibrary hc;
    int N = 19;
    int incX = 1;
    int incY = 1;
...
TEST(hcblas_scopy, func_correct_scopy_Implementation_type_5) {
    Hcblaslibrary hc;
    int N = 19;
    int incX = 1;
    int incY = 1;
