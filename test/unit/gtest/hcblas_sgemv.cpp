...
/* NoTransA */
    ...
    hc::array<float> xbatchView1(lenx * batchSize, xSgemvbatch1);
    hc::array<float> ybatchView1(leny * batchSize, ySgemvbatch1);
    hc::array<float> abatchMat1(M * N * batchSize, ASgemvbatch1);
