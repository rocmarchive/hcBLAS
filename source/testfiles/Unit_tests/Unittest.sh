...
path2sgemm="$HCBLAS_PATH/source/testfiles/build/linux/Test_Executables/sgemm"
path2cgemm="$HCBLAS_PATH/source/testfiles/build/linux/Test_Executables/cgemm"
path2sgemv="$HCBLAS_PATH/source/testfiles/build/linux/Test_Executables/sgemv"
path2sger="$HCBLAS_PATH/source/testfiles/build/linux/Test_Executables/sger"
path2saxpy="$HCBLAS_PATH/source/testfiles/build/linux/Test_Executables/saxpy"
path2sscal="$HCBLAS_PATH/source/testfiles/build/linux/Test_Executables/sscal"
path2dscal="$HCBLAS_PATH/source/testfiles/build/linux/Test_Executables/dscal"
path2scopy="$HCBLAS_PATH/source/testfiles/build/linux/Test_Executables/scopy"
path2dcopy="$HCBLAS_PATH/source/testfiles/build/linux/Test_Executables/dcopy"
path2sasum="$HCBLAS_PATH/source/testfiles/build/linux/Test_Executables/sasum"
path2dasum="$HCBLAS_PATH/source/testfiles/build/linux/Test_Executables/dasum"
path2sdot="$HCBLAS_PATH/source/testfiles/build/linux/Test_Executables/sdot"
path2ddot="$HCBLAS_PATH/source/testfiles/build/linux/Test_Executables/ddot"
