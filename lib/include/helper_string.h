...
inline char *sdkFindFilePath(const char *filename,
  ...
  // input data, or JIT source files)
  // The origin for the relative search may be the .exe file, a .bat file
  ...
  const char *searchPath[] = {
      ...
      "../C/src/<executable_name>/",  // up 1 in tree,
                                      // "/C/src/<executable_name>/" subdir
      "../C/src/<executable_name>/data/",  // up 1 in tree,
                                           // "/C/src/<executable_name>/data/"
                                           // subdir
      "../C/src/<executable_name>/src/",   // up 1 in tree,
                                           // "/C/src/<executable_name>/src/"
                                           // subdir
      "../C/src/<executable_name>/inc/",   // up 1 in tree,
      ...
      "../C/0_Simple/<executable_name>/data/",  // up 1 in tree,
                                                // "/0_Simple/<executable_name>/"
                                                // subdir
      "../C/1_Utilities/<executable_name>/data/",  // up 1 in tree,
                                                   // "/1_Utilities/<executable_name>/"
                                                   // subdir
      "../C/2_Graphics/<executable_name>/data/",  // up 1 in tree,
                                                  // "/2_Graphics/<executable_name>/"
                                                  // subdir
      "../C/3_Imaging/<executable_name>/data/",  // up 1 in tree,
                                                 // "/3_Imaging/<executable_name>/"
                                                 // subdir
      "../C/4_Financial/<executable_name>/data/",  // up 1 in tree,
                                                   // "/4_Financial/<executable_name>/"
                                                   // subdir
      "../C/5_Simulations/<executable_name>/data/",  // up 1 in tree,
                                                     // "/5_Simulations/<executable_name>/"
                                                     // subdir
      "../C/6_Advanced/<executable_name>/data/",  // up 1 in tree,
                                                  // "/6_Advanced/<executable_name>/"
                                                  // subdir
      "../C/7_CUDALibraries/<executable_name>/data/",  // up 1 in tree,
