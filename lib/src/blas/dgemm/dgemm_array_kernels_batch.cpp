...
#define TILESIZE_B 8
  ...
  hc::parallel_for_each(accl_view, t_ext, [ = ] (hc::tiled_index<3> tidx) [[hc]] {
    ...
    double *B_mat = B[elt];
    double *C_mat = C[elt];
    double rC[MICROTILESIZE_A][MICROTILESIZE_B] = {{0}};
    double rA[1][MICROTILESIZE_A];
    double rB[1][MICROTILESIZE_B];
    tile_static double lA[TILESIZE_A * TILESIZE_A * MICROTILESIZE_A];
    tile_static double lB[TILESIZE_A * TILESIZE_B * MICROTILESIZE_B];
    int gidx = tidx.tile[2];
    int gidy = tidx.tile[1];
    int idx = tidx.local[2];
    int idy = tidx.local[1];
...
#define TILESIZE_B 8
  ...
  hc::parallel_for_each(accl_view, t_ext, [ = ] (hc::tiled_index<3> tidx) [[hc]] {
    ...
    double rA[1][MICROTILESIZE_A];
    double rB[1][MICROTILESIZE_B];
    tile_static double lA[TILESIZE_A * TILESIZE_B * MICROTILESIZE_A];
    tile_static double lB[TILESIZE_B * TILESIZE_B * MICROTILESIZE_B];
    int elt = tidx.tile[0];
    double *A_mat = A[elt];
    double *B_mat = B[elt];
    double *C_mat = C[elt];
