...
hcblasStatus zgemm_TransAB_rMajor_batch_loopunroll(hc::accelerator_view &accl_view,
...
hcblasStatus zgemm_TransAB_rMajor_batch_MICRO_TS16XMTS2(hc::accelerator_view &accl_view,
						        double_2 *A, long aOffset, long A_batchOffset,
						        double_2 *B, long bOffset, long B_batchOffset,
						        double_2 *C, long cOffset, long C_batchOffset,
						        int M, int N, int K, int lda, int ldb, int ldc,
...
hcblasStatus zgemm_TransAB_rMajor_batch_STEP_TS8XSS8(hc::accelerator_view &accl_view,
						     double_2 *A, long aOffset, long A_batchOffset,
						     double_2 *B, long bOffset, long B_batchOffset,
						     double_2 *C, long cOffset, long C_batchOffset,
						     int M, int N, int K, int lda, int ldb, int ldc,
...
hcblasStatus zgemm_TransAB_rMajor_batch_MICRO_TS8XMTS2(hc::accelerator_view &accl_view,
						       double_2 *A, long aOffset, long A_batchOffset,
						       double_2 *B, long bOffset, long B_batchOffset,
						       double_2 *C, long cOffset, long C_batchOffset,
						       int M, int N, int K, int lda, int ldb, int ldc,
...
hcblasStatus zgemm_NoTransB_rMajor_batch_MICRO_TS16XMTS2(hc::accelerator_view &accl_view,
						         double_2 *A, long aOffset, long A_batchOffset,
						         double_2 *B, long bOffset, long B_batchOffset,
						         double_2 *C, long cOffset, long C_batchOffset,
						         int M, int N, int K, int lda, int ldb, int ldc,
...
hcblasStatus zgemm_NoTransA_rMajor_batch_STEP_TS8XSS8(hc::accelerator_view &accl_view,
						      double_2 *A, long aOffset, long A_batchOffset,
						      double_2 *B, long bOffset, long B_batchOffset,
						      double_2 *C, long cOffset, long C_batchOffset,
						      int M, int N, int K, int lda, int ldb, int ldc,
...
hcblasStatus zgemm_NoTransA_rMajor_batch_MICRO_TS16XMTS2(hc::accelerator_view &accl_view,
						         double_2 *A, long aOffset, long A_batchOffset,
						         double_2 *B, long bOffset, long B_batchOffset,
						         double_2 *C, long cOffset, long C_batchOffset,
						         int M, int N, int K, int lda, int ldb, int ldc,
...
hcblasStatus zgemm_NoTransA_rMajor_batch_loopunroll(hc::accelerator_view &accl_view,
						    double_2 *A, long aOffset, long A_batchOffset,
						    double_2 *B, long bOffset, long B_batchOffset,
						    double_2 *C, long cOffset, long C_batchOffset,
						    int M, int N, int K, int lda, int ldb, int ldc,
...
hcblasStatus zgemm_NoTransAB_rMajor_batch_STEP_TS8XSS8(hc::accelerator_view &accl_view,
						       double_2 *A, long aOffset, long A_batchOffset,
						       double_2 *B, long bOffset, long B_batchOffset,
						       double_2 *C, long cOffset, long C_batchOffset,
						       int M, int N, int K, int lda, int ldb, int ldc,
...
hcblasStatus zgemm_NoTransAB_rMajor_batch_STEP_TS16XSS16(hc::accelerator_view &accl_view,
						         double_2 *A, long aOffset, long A_batchOffset,
						         double_2 *B, long bOffset, long B_batchOffset,
						         double_2 *C, long cOffset, long C_batchOffset,
						         int M, int N, int K, int lda, int ldb, int ldc,
...
hcblasStatus zgemm_NoTransAB_rMajor_batch_MICRO_TS16XMTS2(hc::accelerator_view &accl_view,
						          double_2 *A, long aOffset, long A_batchOffset,
						          double_2 *B, long bOffset, long B_batchOffset,
						          double_2 *C, long cOffset, long C_batchOffset,
						          int M, int N, int K, int lda, int ldb, int ldc,
...
hcblasStatus zgemm_TransAB_rMajor(hc::accelerator_view &accl_view,
  ...
  if (M < 600 && N < 600 && K >= 600 && K < 1800) {
    return zgemm_TransAB_rMajor_batch_loopunroll(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
  } else if (M >= 600 && M < 6000 && N < 600 && K < 1800) {
    return zgemm_TransAB_rMajor_batch_MICRO_TS16XMTS2(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
  } else if (M >= 1800 && M < 6000 && N < 10 && K >= 600 && K < 6000) {
    return zgemm_TransAB_rMajor_batch_STEP_TS8XSS8(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
  } else if (M >= 6000 && M < 10000 && N < 10 && K >= 1800 && K < 6000) {
    return zgemm_TransAB_rMajor_batch_MICRO_TS8XMTS2(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
  } else {
    return zgemm_TransAB_rMajor_batch_MICRO_TS16XMTS2(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
  }
}
...
hcblasStatus zgemm_NoTransB_rMajor(hc::accelerator_view &accl_view,
  ...
  { */
  return zgemm_NoTransB_rMajor_batch_MICRO_TS16XMTS2(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
  //}
}
...
hcblasStatus zgemm_NoTransA_rMajor(hc::accelerator_view &accl_view,
  ...
  if ((M >= 10 && M < 6000 && N < 600 && K < 10) || (  M >= 600 && M < 1800 && N < 10 && K >= 1800 && K < 6000) || ( M < 600 && N < 600 && K > 1800 && K < 6000)) {
    return zgemm_NoTransA_rMajor_batch_STEP_TS8XSS8(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
  } else if (M >= 600 && M < 6000 && N < 600 && K < 600) {
    return zgemm_NoTransA_rMajor_batch_MICRO_TS16XMTS2(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
  } else if (M > 1800 && M < 6000 && N < 600 && K >= 1800 && K < 10000 ) {
    return zgemm_NoTransA_rMajor_batch_loopunroll(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
  } else {
    return zgemm_NoTransA_rMajor_batch_MICRO_TS16XMTS2(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
  }
}
...
hcblasStatus zgemm_NoTransAB_rMajor(hc::accelerator_view &accl_view,
  ...
  if ((M < 600 && N < 600 && K < 10) || (M < 1800 && N < 600 && K < 600)) {
    return zgemm_NoTransAB_rMajor_batch_STEP_TS8XSS8(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
  } else if ((M < 600 && N < 600 && K < 1800) || (M < 1800 && ((N < 600 && K < 1800) || (N < 1800 && K < 10)))) {
    return zgemm_NoTransAB_rMajor_batch_STEP_TS16XSS16(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
  } else { /*if (M < 1800 && N < 1800 && K < 1800)*/
    return zgemm_NoTransAB_rMajor_batch_MICRO_TS16XMTS2(accl_view, A, aOffset, A_batchOffset, B, bOffset, B_batchOffset, C, cOffset, C_batchOffset, M, N, K, lda, ldb, ldc, alpha, beta, batchSize);
  }
}
